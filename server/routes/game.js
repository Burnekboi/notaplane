...
function getAchievementStatus(user) {
  ...
  const achievements = [
    ...
    { id: 'ensign', name: 'Ensign', task: 'Rank up to Ensign', progress: Math.min(user.total_kills || 0, 1000), max: 1000, reward: 5000 },
    { id: 'lieutenant', name: 'Lieutenant', task: 'Rank up to Lieutenant', progress: Math.min(user.total_kills || 0, 10000), max: 10000, reward: 15000 },
    { id: 'commander', name: 'Commander', task: 'Rank up to Commander', progress: Math.min(user.total_kills || 0, 100000), max: 100000, reward: 50000 },
  ];
